...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "inString": function() { return /* binding */ inString; },
/* harmony export */   "isAddBlockCss": function() { return /* binding */ isAddBlockCss; }
/* harmony export */ });
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _monaco_editor_react__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @monaco-editor/react */ "./node_modules/@monaco-editor/react/lib/es/index.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./style.scss */ "./src/advanced-block-css/style.scss");
/* harmony import */ var _utils_logo__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/logo */ "./src/utils/logo.js");
/* harmony import */ var _edit_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./edit.js */ "./src/advanced-block-css/edit.js");
...
const inString = (str, keyword) => {
  return str.indexOf(keyword) !== -1;
};
const isAddBlockCss = blockName => {
  // coreブロックの時 true を返す
  const allowed = ['core'];
  const returnBool = allowed.find(item => inString(blockName, item)) !== undefined;
  return returnBool;
};
/**
 * Block.json
...
const abcRegisterBlockTypeFuc = settings => {
  if (isAddBlockCss(settings.name) && (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_5__.hasBlockSupport)(settings, 'customClassName', true)) {
    settings.attributes = (0,lodash__WEBPACK_IMPORTED_MODULE_6__.assign)(settings.attributes, {
      advancedBlockCss: {
        type: 'string',
        default: null
      }
...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_1__.addFilter)('blocks.registerBlockType', 'advanced-block-css/register-block-type', abcRegisterBlockTypeFuc);
/**
 * edit.js
 */

const abcBlockEditFunc = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_4__.createHigherOrderComponent)(BlockEdit => {
  return props => {
    const {
      name,
      attributes,
    ...
    const hasCustomClassName = (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_5__.hasBlockSupport)(name, 'customClassName', true);
    const editorOption = advancedBlockCssOptions.editor;

    const onChange = value => {
      setAttributes({
        advancedBlockCss: value
      });
    };
    ...
    if (isAddBlockCss(props.name) && hasCustomClassName && isSelected) {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(BlockEdit, props), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
        ...
        icon: _utils_logo__WEBPACK_IMPORTED_MODULE_9__.ABCIconBold,
        initialOpen: advancedBlockCss ? true : false
      }, editorOption === 'CodeMirror' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_edit_js__WEBPACK_IMPORTED_MODULE_10__["default"], props), editorOption === 'MonacoEditor' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_monaco_editor_react__WEBPACK_IMPORTED_MODULE_7__["default"], {
        className: "abc-editor",
        height: "200px",
        defaultLanguage: "css",
        options: {
        ...
        onChange: onChange
      }), editorOption === 'PlainText' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.PlainText, {
...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_1__.addFilter)('editor.BlockEdit', 'advanced-block-css/block-edit', abcBlockEditFunc);
/**
 * edit.js
 */

const abcBlockListBlockFun = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_4__.createHigherOrderComponent)(BlockListBlock => {
  return props => {
    const acsStyle = props.attributes.advancedBlockCss ? props.attributes.advancedBlockCss : '';
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, acsStyle ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", null, acsStyle) : null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(BlockListBlock, props));
  };
}, 'abcBlockListBlock');
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_1__.addFilter)('editor.BlockListBlock', 'advanced-block-css/block-list-block', abcBlockListBlockFun);
